                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control show-tick">
                                                ...
                                                <option value="10">Mayra Beatrriz Martinez</option>
                                                <option value="20">Cristian Diaz</option>
                                                <option value="30">Kendra Zoe Merino</option>
                                                <option value="40">Fernando Isaac Duran</option>
                                                <option value="50">Katherine Elizabeth Rivas</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
