...
<table class="table table-hover" width="100%" border="0">	 
      <tr class="well">
		<td colspan="6"><strong><center>INVENTARIO GENERAL</center></strong></td>
		</tr>		
</table>
...
<table width="100%" border="0">			
		  <tr>
			...
			<td width="100%" colspan="2">
			  <div align="center">
				<span class="text">'.$empresa.'<br/> Nit. '.$nit.'</span><br/>
    ...
    <table class="table table-hover" width="100%" border="0">
      <tr class="well">
		...
		$num=0;
        $can=mysql_query("SELECT * FROM inventario ORDER BY articulo");	
  	  ...
  	  $codigoHTML.='
      <tr>        
        <td align="center" bgcolor="'.$color.'">'.$dato['codigo'].'</td>
        <td bgcolor="'.$color.'">'.$oArticulo->consultar('nombre').'</td>             
        <td bgcolor="'.$color.'"><div align="center">'.$dato['stock'].'<div></td>                
        <td bgcolor="'.$color.'">'.$oCategoria->consultar('nombre').'</td>                      
      </tr>';
         }
	$codigoHTML.='
	</table>
...
<!-- Le javascript ../../js/jquery.js
    ...
    $dompdf->render();
    $dompdf->stream("Listado_Inventario_".$fecha.".pdf");
