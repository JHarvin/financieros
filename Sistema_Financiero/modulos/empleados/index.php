<?php 
    ...
    if(!empty($_GET['del'])){
        $id=$_GET['del'];
        mysql_query("DELETE FROM empleados WHERE id='$id'");
...
font-size: 16px;">Almacen: <?php echo $nombre_Almacen; ?> :: Fecha de Acceso : <?php echo fecha(date('Y-m-d')); ?>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
            <?php if(permiso($_SESSION['cod_user'],'15')==TRUE){ ?>
			 <div class="row">
                    <div class="col-md-12">                        
                          <div class="panel-body" align="center">                                                                                 
                            <button type="button" class="btn btn-success btn-circle" data-toggle="modal" data-target="#myModal" title="Agregar Empleado"><i class="fa fa-plus fa-2x"></i>
                            </button>
                             <button type="button" class="btn btn-info btn-circle"  onClick="window.location='PDFempleado.php'" title="Reporte PDF"><i class="fa fa-list-alt fa-2x"></i>
                            </button>                                                                                 
                  </div>
                    </div>
                </div> 
                                                 ...
                                                 <div class="modal-header">
                                                    ...
                                                    <h3 align="center" class="modal-title" id="myModalLabel">Nuevo Empleado</h3>
                                                        ...
                                                        <input class="form-control" title="Se necesita una Direccion" name="dir" placeholder="Procedencia"  autocomplete="off" required><br>  
                                                           ...
                                                           <div class="col-md-4">
                                                             <input class="form-control" name="tel" title="Se necesita un Telefono" placeholder="Telefono" autocomplete="off" required><br>                                                            
                                                             </div>
                                                            <div class="col-md-4">
                                                              <input class="form-control" name="dui" title="Se necesita un Cedula"  placeholder="Cedula" autocomplete="off" required><br>                                                                                                                                                                          
                                                            </div>
                                                            <div class="col-md-4">                                                     
                                                              <input class="form-control" name="nit" title="Se necesita un NRC" placeholder="NIT" autocomplete="off" required><br>
                                                            </div>
                                                            <div class="col-md-6">
                                                                 <input class="form-control" title="Se necesita un Cargo" name="cargo" placeholder="Cargo"  autocomplete="off" required><br>
                                                            ...
                                                            <div class="col-md-6">
                                                             <input class="form-control" title="Se necesita un Sueldo" name="sueldo" placeholder="Sueldo"  autocomplete="off" required><br>
                                                               <div class="input-group">
                        ...
                        <div class="panel-body">
                            ...
                            <?php 
                                    if(!empty($_POST['nombre'])){                                               
                                        ...
                                        $sueldo=limpiar($_POST['sueldo']);                                                                                                         
                                        $estado=limpiar($_POST['estado']);
                                        
                                        if(empty($_POST['id'])){
                                            $oEmpleado=new Proceso_Empleado('',$nombre,$dir,$dui,$sexo,$tel,$nit,$cargo,$sueldo,$estado);
                                            $oEmpleado->crear();
                                            echo mensajes('Empleado "'.$nombre.'" Creado con Exito','verde');
                                        }else{
                                            $id=limpiar($_POST['id']);
                                            $oEmpleado=new Proceso_Empleado($id,$nombre,$dir,$dui,$sexo,$tel,$nit,$cargo,$sueldo,$estado);
                                            $oEmpleado->actualizar();
                                            echo mensajes('Empleado "'.$nombre.'" Actualizado con Exito','verde');
                                        }
                                    }
                                ?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php                                             
                                            $pame=mysql_query("SELECT * FROM empleados ORDER BY nombre");                                                        
                                            while($row=mysql_fetch_array($pame)){
                                        ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $row['nombre']; ?></td>
                                            <td><?php echo $row['cargo']; ?></td>
                                            <td><?php echo formato($row['sueldo']); ?></td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h3 align="center" class="modal-title" id="myModalLabel">Editar Empleado</h3>
                                                            </div>
                                                            <div class="panel-body">
                                                            <div class="row">                                       
                                                                <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                          ...
                                                                          <input class="form-control" title="Se necesita una Procedencia"  name="dir" value="<?php echo $row['dir']; ?>" autocomplete="off" required><br>                                         
                                                                    </div><br>                                          
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-group">
                                                                          <span class="input-group-addon">Tel</span>
                                                                          <input class="form-control" title="Se necesita un nombre"  name="tel" data-mask="9999-9999" value="<?php echo $row['tel']; ?>" autocomplete="off" required><br>                                         
                                                                    </div><br>                                          
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-group">
                                                                          <span class="input-group-addon">DUI</span>
                                                                          <input class="form-control" title="Se necesita un DUI"  name="dui" data-mask="9999-999999-9999-9" value="<?php echo $row['dui']; ?>" autocomplete="off" required><br>                                         
                                                                    </div><br>                                          
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="input-group">
                                                                          <span class="input-group-addon">NIT</span>
                                                                          <input class="form-control" title="Se necesita un NIT"  name="nit" data-mask="999999-9" value="<?php echo $row['nit']; ?>" autocomplete="off" required><br>                                         
                                                                    </div><br>                                          
                                                                </div>
                                                                 <div class="col-md-6">
                                                                  <div class="input-group">
                                                                          <span class="input-group-addon">Cargo</span>
                                                                          <input class="form-control" title="Se necesita un Cargo"  name="cargo"  value="<?php echo $row['cargo']; ?>" autocomplete="off" required><br>                                         
                                                                    </div><br>                                                                                            
                                                                     <div class="input-group">
                                                                      <span class="input-group-addon">Sexo</span>
                                                                      <select class="form-control" name="sexo" autocomplete="off" required>
                                                                ...
                                                                <div class="col-md-6">
                                                                 <div class="input-group">
                                                                          ...
                                                                          <input class="form-control" title="Se necesita un Sueldo"  name="sueldo"  value="<?php echo $row['sueldo']; ?>" autocomplete="off" required><br>                                         
                                                                    </div><br>                                                                                            
                                                                     <div class="input-group">
                                                                      <span class="input-group-addon">Estado</span>
                                                                      <select class="form-control" name="estado" autocomplete="off" required>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="row" align="center">                                       
                                                                ...
                                                                <div class="alert alert-danger">
                                                                    ...
                                                                    una vez Eliminado el Empleado <strong>[ <?php echo $row['nombre']; ?> ]</strong> sus datos no podran ser Recuperados. 
