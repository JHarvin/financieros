...
<html lang="es">
  <head>
		<meta charset="utf-8">
		<title>Listo de Empleados</title>
...
<table class="table table-hover" width="100%" border="0">	 
      <tr class="well">
		<td colspan="6"><strong><center>LISTADO DE EMPLEADOS</center></strong></td>
		</tr>		
</table>
...
<table width="100%" border="0">		
    ...
    <table class="table table-hover" width="100%" border="0">
      <tr class="well">
		...
		$num=0;
        $can=mysql_query("SELECT * FROM empleados WHERE estado='s' ORDER BY id");	
      ...
      <tr>        
        ...
        <td bgcolor="'.$color.'">'.$dato['cargo'].'</td>
        <td bgcolor="'.$color.'">'.$s.''.formato($dato['sueldo']).'</td>          
      </tr>';
         }
	$codigoHTML.='
	</table>
...
<!-- Le javascript ../../js/jquery.js
    ...
    $dompdf->render();
    $dompdf->stream("Listado_Empleados_".$fecha.".pdf");
