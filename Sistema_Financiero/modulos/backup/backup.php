...
font-size: 16px;">Almacen: <?php echo $nombre_Almacen; ?> :: Fecha de Acceso : <?php echo fecha(date('Y-m-d')); ?>
  ...
  <FORM action="<?php echo $_SERVER['PHP_SELF']?>" method="GET" >
   <div class="col-md-6">
    <INPUT type="hidden" class="form-control" name="host" id ="host" value="127.0.0.1">
   <INPUT type="hidden" class="form-control" name="bd" id ="bd" value="bdtiendita"><br />
   </div>
   <div class="col-md-6">
   <INPUT type="hidden" class="form-control" name="usuario" id ="usuario" value="root">
  <INPUT class="form-control" type="hidden" name="passwd" id="passwd" value=""><br />
   </div>
   <div class="col-md-4">
    </div>
   <div class="col-md-4">
