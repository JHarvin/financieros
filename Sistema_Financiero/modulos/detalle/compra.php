<?php 
    ...
    ######### TRAEMOS LOS DATOS DE LA EMPRESA #############
        ...
        $pax=mysql_query("SELECT * FROM resumen_comp WHERE factura='$factura'");             
            ...
            <div id="page-inner">
                ...
                <table>             
                 <tr>
                    ...
                    <!-- /. TABLA  -->
                <?php 
                $oPaciente=new Consultar_Proveedor($row['proveedor']);

                ?>
                <hr/>
                <strong>PROVEEDOR:</strong> <?php echo $oPaciente->consultar('nombre'); ?><br>
                <strong>FECHA DE COMPRA:</strong> <?php echo fecha($row['fecha']); ?><br><br>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover"  width="100%" rules="all"  border="1">                                    
                                    ...
                                    <tbody>
                                         <?php
                                            $neto=0;
                                            $pa=mysql_query("SELECT * FROM detalle_comp WHERE factura='$factura' ORDER BY nombre");              
                                            while($row=mysql_fetch_array($pa)){
