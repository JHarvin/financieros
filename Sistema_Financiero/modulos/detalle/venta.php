                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover"  width="100%" rules="all"  border="1">                                    
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $neto_total=0;
                                            $f=mysql_query("SELECT * FROM factura WHERE factura='$factura'");              
                                            if($rowf=mysql_fetch_array($f)){
                                                $neto_total=$rowf['valor'];
                                            }
                                          ?>
                                        <tr>
                                             <td colspan="4"><div align="right"><strong><h4>Total</h4></strong></div></td>
                                             <td><div align="right"><strong><h4>$ <?php echo formato($neto_total); ?></h4></strong></div></td>
                                        </tr>
                                    </tbody>                                    
                                </table><br><br><br><br>
                                     <hr/>
