...
<table class="table table-hover" width="100%" border="0">	 
      <tr class="well">
		<td colspan="6"><strong><center>LISTADO DE ARTICULOS</center></strong></td>
		</tr>		
</table>
...
<table width="100%" border="0">		
    ...
    <table class="table table-hover"  width="100%" border="0">
      <tr class="well">
		...
		$num=0;
        $can=mysql_query("SELECT * FROM articulos ORDER BY id");	
      ...
      <tr>        
        ...
        <td bgcolor="'.$color.'">'.$dato['valor'].'</td>                      
      </tr>';
         }
	$codigoHTML.='
	</table>
...
<!-- Le javascript ../../js/jquery.js
    ...
    $dompdf->render();
    $dompdf->stream("Listado_Articulos_".$fecha.".pdf");
