                                    ...
                                    <?php                                             
                                            ...
                                            while($row=mysql_fetch_array($pame)){
                                                ...
                                                if($row['inv']== NULL){
                                                        ...
                                                        $asignar='<a href="#" data-toggle="modal" data-target="#asignar'.$id_art.'" class="btn btn-danger btn-sm" title="Asignar Almacen"><i class=" fa fa-plus"></i></a>';
                                                    }else{
                                                        $asignar='<a href="#" data-toggle="modal" data-target="#asignar'.$id_art.'" class="btn btn-success btn-sm"><i class=" fa fa-check "></i></a>';
                                                    }
                                                 if($row['prov']== NULL){
                                                        #$asignar='<a href="asignaciones.php?codigo='.$url.'" class="btn btn-success btn-sm"><i class=" fa fa-arrow-right"></i></a>';
                                                        $prov='<a href="#" data-toggle="modal" data-target="#prov'.$id_art.'" class="btn btn-danger btn-sm" title="Asignar Proveedor"><i class=" fa fa-user"></i></a>';
                                                    }else{
                                                        $prov='<a href="#" data-toggle="modal" data-target="#prov'.$id_art.'" class="btn btn-success btn-sm"><i class=" fa fa-check "></i></a>';
                                                    }          
                                        ?>
                                        <tr class="odd gradeX">
