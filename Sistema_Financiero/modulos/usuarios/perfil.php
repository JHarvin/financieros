<?php 
    ...
    $paaw=mysql_query("SELECT * FROM persona WHERE doc='$usu'");              
                ...
                <?php 
                    if(!empty($_POST['c1']) and !empty($_POST['c2']) and !empty($_POST['contra'])){
                        if($_POST['c1']==$_POST['c2']){
                            ...
                            $can=mysql_query("SELECT * FROM usuario WHERE doc='".$usuario."' and con='".$contra."'");
                            if($dato=mysql_fetch_array($can)){
                                $cnueva=limpiar($_POST['c2']);
                                $sql="Update usuario Set con='$cnueva' Where doc='$usuario'";
                                mysql_query($sql);
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">           
                    <div class="panel panel-back noti-box">               
                        <div class="text-box" >
                            ...
                            <hr />
                            <p class="">                   
                            <i class="fa fa-edit"></i><strong> Documento: </strong> <?php echo $usu; ?><br><br>
                            <i class="fa fa-phone"></i><strong> Cargo: </strong> <?php echo $cargo; ?><br><br>                           
                            </p>
                        </div>
                     </div>
                </div>
