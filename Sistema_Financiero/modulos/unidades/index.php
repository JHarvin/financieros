                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 align="center" class="modal-title" id="myModalLabel">Nueva Unidad</h3>
                                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <?php 
                                    if(!empty($_POST['nombre'])){                                               
                                        ...
                                        if(empty($_POST['id'])){
                                            $oUnidad=new Proceso_Unidad('',$nombre,$estado);
                                            $oUnidad->crear();
                                            echo mensajes('Unidad "'.$nombre.'" Creada con Exito','verde');
                                        }else{
                                            $id=limpiar($_POST['id']);
                                            $oUnidad=new Proceso_Unidad($id,$nombre,$estado);
                                            $oUnidad->actualizar();
                                            echo mensajes('Unidad "'.$nombre.'" Actualizada con Exito','verde');
                                        }
                                    }
                                ?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php                                             
                                            $pame=mysql_query("SELECT * FROM unidades ORDER BY nombre");                                                        
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h3 align="center" class="modal-title" id="myModalLabel">Editar Unidad</h3>
                                                            </div>
                                                            <div class="panel-body">
                                                            <div class="row">                                       
                                                                <div class="col-md-6">
