			 ...
			 <div class="row">
                    <div class="col-md-12">                        
                          <div class="panel-body" align="right">                                                                                 
                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal" title="Agregar Categoria"><i class="fa fa-plus fa-2x"></i>Agregar categoria
                            </button>                                                                               
                  </div>
                    </div>
                </div> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 align="center" class="modal-title" id="myModalLabel">Nuevo Categoria</h3>
                                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <?php 
                                    if(!empty($_POST['nombre'])){                                               
                                        ...
                                        if(empty($_POST['id'])){
                                            $oCategoria=new Proceso_Categoria('',$nombre,$estado);
                                            $oCategoria->crear();
                                            echo mensajes('Categoria "'.$nombre.'" Creada con Exito','verde');
                                        }else{
                                            $id=limpiar($_POST['id']);
                                            $oCategoria=new Proceso_Categoria($id,$nombre,$estado);
                                            $oCategoria->actualizar();
                                            echo mensajes('Categoria "'.$nombre.'" Actualizada con Exito','verde');
                                        }
                                    }
                                ?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php                                             
                                            $pame=mysql_query("SELECT * FROM categorias ORDER BY nombre");                                                        
                                                            ...
                                                            <div class="row">                                       
                                                                <div class="col-md-6">
                                                                    <div class="input-group">
                                                                          ...
                                                                          <input class="form-control" title="Se necesita un nombre"  name="nombre" placeholder="Nombre Completo" value="<?php echo $row['nombre']; ?>" autocomplete="off" required onKeyUp="this.value=this.value.toUpperCase();"><br>                                         
                                                                    </div>                                          
                                                                </div>
                                                                <div class="col-md-6">                                                                                          
                                                                     <div class="input-group">
