<?php 
   ...
   $bus='';#inicializar la variable
        if(!empty($_GET['estado'])){
            ...
            $cans=mysql_query("SELECT * FROM resumen_comp WHERE id='$nit'");
            if($dat=mysql_fetch_array($cans)){
                if($dat['estado']=='s'){                    
                    $xSQL="Update resumen_comp Set estado='n' WHERE id='$nit'";
                    mysql_query($xSQL);
                    header('location:operaciones.php');
                }else{
                    $xSQL="Update resumen_comp Set estado='s' WHERE id='$nit'";
                    mysql_query($xSQL);
                    header('location:operaciones.php');
                }
            }
			  ...
			  <?php 
                ...
                if(!empty($_GET['trans'])){
                    ...
                    $where="WHERE usu='".$usu."' and fecha between '$fechai' AND '$fechaf'";
                            ...
                            $sqlx=mysql_query("SELECT * FROM resumen_comp WHERE fecha between '$fechai' AND '$fechaf' and estado='s'");
                           ...
                           <div class="row"> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="trans">
                                        ...
                                        <option value="OPERACION" <?php if($trans=='COMPRA'){ echo 'selected'; } ?>>COMPRA</option>                                       
                                    </select>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php 
                                            $sql=mysql_query("SELECT * FROM resumen_comp ".$where);
                                            while($row=mysql_fetch_array($sql)){
                                                ...
                                                ############# CONSULTAS ######################
                                                $oCliente=new Consultar_Proveedor($row['proveedor']);
                                                if ($row['proveedor']==NULL) {
                                                    $consulta='PROVEEDORES VARIOS';
                                                }
                                                else{
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                            <a href="../detalle/compra.php?detalle=<?php echo $url; ?>"  class="btn btn-info" title="Detalle">
