                                    ...
                                    <td width="50%">
                                        ...
                                        <form method="post" action="" enctype="multipart/form-data" name="form1" id="form1">
                                          <div class="input-group">
                                                 <input class="form-control" name="search" type="text" class="span2" size="60" list="browsers1" autocomplete="off" placeholder="Buscar Factura">
                                                  <datalist id="browsers1">
                                                  <?php
                                                    $search=$_POST['busfact'];
                                                    $canf=mysql_query("SELECT * FROM resumen"); 
                                                    while($dato=mysql_fetch_array($canf)){
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php 
                                             if(empty($_POST['search'])){
                                                $sqly=mysql_query("SELECT * FROM resumen ORDER BY id DESC LIMIT 10");
                                            }else{
                                                $search=$_POST['search'];
                                                $sqly=mysql_query("SELECT * FROM resumen where factura LIKE '$search%'");
                                            }        
                                            while($row=mysql_fetch_array($sqly)){
                            ...
                            <div class="table-responsive">
                             <table width="100%" border="0">
                                  <tr>
                                    <td width="50%">
                                        <div align="right">
                                        <form method="post" action="" enctype="multipart/form-data" name="form1" id="form2">
                                          <div class="input-group">
                                                 <input class="form-control" name="bus" type="text" class="span2" size="60" list="browsers1" autocomplete="off" placeholder="Buscar Ticket">
                                                  <datalist id="browsers1">
                                                  <?php
                                                    $buscar=$_POST['bus'];
                                                    $cant=mysql_query("SELECT * FROM resumen_ticket"); 
                                                    while($tk=mysql_fetch_array($cant)){
                                                        echo '<option value="'.$tk['factura'].'">';
                                                    }
                                                  ?>
                                              </datalist>
                                            </td>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php 
                                             if(empty($_POST['bus'])){
                                                $sql=mysql_query("SELECT * FROM resumen_ticket ORDER BY id DESC LIMIT 10");
                                            }else{
                                                $buscar=$_POST['bus'];
                                                $sql=mysql_query("SELECT * FROM resumen_ticket where factura LIKE '$buscar%'");
                                            }        
                                            while($row=mysql_fetch_array($sql)){
