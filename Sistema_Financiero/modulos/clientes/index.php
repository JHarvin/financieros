                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          <div class="panel-body" align="right">
                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal" title="Agregar Nuevo Cliente"><i class="fa fa-plus fa-2x"></i>
                              Agregar cliente
                            </button>
                             <button type="button" class="btn btn-info" onClick="window.location='PDFcliente.php'" title="Reporte PDF"><i class="fa fa-list-alt fa-2x"></i>
                               Reporte de clientes
                            </button>
                  </div>
