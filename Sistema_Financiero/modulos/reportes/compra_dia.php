                                     ...
                                     <tr>
                                      ...
                                      <hr/>
                                          <div style="font-size: 14px;"align="center">
                                             <strong>COMPRA DE ARTICULOS DEL DIA</strong><br>                              
                                        </div> 
                                        <hr/>
                                    </div>
                                            ...
                                            <tr><td>
                                                    ...
                                                    <tbody>
                                                         <?php
                                                            $neto=0;
                                                            $total=0;
                                                            $pax=mysql_query("SELECT sum(cantidad) as cant, sum(importe) as imp, codigo,cantidad,valor,codigo,nombre FROM detalle_comp WHERE categoria='$id_cat' and almacen='$id_almacen' and tipo='$tip' and fecha between '$fechai' AND '$fechaf' group by codigo");              
                                        ...
                                        <?php } ?>
                                         <table class="table table-striped table-bordered table-hover"  width="100%" style="font-size: 12px;"  border="0">       
                                          ...
                                          <?php
                                            ...
                                            $totalx=0; 
                                            $total_gen=0;                     
                                            $gen=mysql_query("SELECT * FROM detalle_comp WHERE tipo='$tip' and fecha between '$fechai' AND '$fechaf'");       
