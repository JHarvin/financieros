...
font-size: 16px;">Almacen: <?php echo $nombre_Almacen; ?> :: Fecha de Acceso : <?php echo fecha(date('Y-m-d')); ?>
        ...
        <div id="page-wrapper" >
            ...
            <div class="panel-footer back-footer-blue">
             EXISTENCIAS Y COSTOS DE PRODUCTOS POR ALMACEN
            </div>
                                     ...
                                     <tr>
                                      ...
                                      <hr/>
                                          <div style="font-size: 14px;"align="center">
                                             <strong>EXISTENCIAS Y COSTOS DE PRODUCTOS POR ALMACEN</strong><br>                              
                                        </div> 
                                        <hr/>
                                    </div>
                                        ...
                                        <table class="table table-bordered" width="100%"  style="border: 1px solid #660000; -moz-border-radius: 10px;-webkit-border-radius: 12px;padding: 10px;">
                                            <tr><td>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <td colspan="5"><strong>Almacen: [<?php echo $row['id']; ?>] <?php echo $row['nombre']; ?> </strong></td>
                                                        </tr> 
                                                        <tr>
                                                            <th>CODIGO</th>                                                                                                                                                                           
                                                    ...
                                                    <tbody>
                                                         <?php
                                                            ...
                                                            while($row=mysql_fetch_array($pax)){
                                                              $oProducto=new Consultar_Articulos($row['articulo']);
                                                                ...
                                                                $cant=$row['stock'];
                                                                $importe=$oProducto->consultar('valor');
                                                                $ref=$row['stock'];
                                                                $total=$cant*$importe;
                                                                $neto=$neto+$total;                                                                                               
                                                          ?>
                                                        <tr>                                                   
                                                            ...
                                                            <td><div align="right"><strong><?php echo $s.' '.formato($oProducto->consultar('valor')); ?></strong></div></td>
