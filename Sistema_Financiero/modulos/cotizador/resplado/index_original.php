                                                    ...
                                                    <h3 align="center" class="modal-title" id="myModalLabel">Nuevo Cliente</h3>
                                                        ...
                                                        <input class="form-control" title="Se necesita una Direccion" name="dir" placeholder="Procedencia"  autocomplete="off" required><br>  
                                                           ...
                                                           <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                              <input class="form-control" name="dui" title="Se necesita un NIT" placeholder="NIT" autocomplete="off" required><br>                                                                                                                                                                          
                                                            </div>
                                                            <div class="col-md-4">                                                     
                                                              <input class="form-control" name="nrc" title="Se necesita un NRC" placeholder="NRC" autocomplete="off" required><br>
                                                            </div>
                                                            <div class="col-md-6">
                        ...
                        <div class="modal fade" id="consultas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">                                                   
                            ...
                            <div class="modal-dialog">
                                ...
                                <ul class="nav nav-tabs nav-justified">
                                            <li class="active"><a href="#datos" data-toggle="tab"><i class="glyphicon glyphicon-download-alt" ></i> EXISTENCIA Y PRECIOS</a></li>
                                            <li class="" ><a href="#tipo" data-toggle="tab"><i class="glyphicon glyphicon-th" ></i> UBICACIÓN</a></li>                                                                                                                                                                                     
                                </ul> 
                                <div class="tab-content">
                                ...
                                <tbody>
                                          <?php 
                                            $paa=mysql_query("SELECT * FROM inventario WHERE almacen='$id_almacen'");                    
                                            while($dato=mysql_fetch_array($paa)){
                                            $oArticulos=new Consultar_Articulos($dato['articulo']);
                                ...
                                <tbody>
                                 <?php
                                            $pa=mysql_query("SELECT articulos.nombre,articulos.modelo,articulos.estante,articulos.marca FROM inventario, articulos 
                                            WHERE articulos.codigo=inventario.codigo and inventario.almacen='$id_almacen'");               
                                            while($row=mysql_fetch_array($pa)){
                                            $oTipo=new Consultar_Tipo($row['estante']);
                                            $oMarca=new Consultar_Marca($row['marca']);
                                        ?> 
                                          <tr>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-12">
                    ...
                    if(!empty($_POST['fecha'])){
                        ...
                        mysql_query("UPDATE clcot_tmp SET fecha='$fecha' WHERE cliente='$ncodigof' and usu='$usu'");
                    }
                    
                    if(!empty($_POST['status'])){
                        $status=limpiar($_POST['status']);
                        $ncodigos=limpiar($_POST['ncodigos']);
                        mysql_query("UPDATE clcot_tmp SET status='$status' WHERE cliente='$ncodigos' and usu='$usu'");
                    }
                    
                    if(!empty($_POST['status'])){
                        $statusx=limpiar($_POST['status']);
                        $ncodigos=limpiar($_POST['ncodigos']);
                        mysql_query("UPDATE clcot_tmp SET status='$statusx' WHERE cliente='$ncodigos' and usu='$usu'");
                    }
                
                    if(!empty($_POST['buscar_cliente'])){
                        $buscarc=limpiar($_POST['buscar_cliente']);
                        $poa=mysql_query("SELECT clientes.id, clientes.email, clientes.tel FROM clientes 
                        ...
                        if($roow=mysql_fetch_array($poa)){
                            ...
                            $pa=mysql_query("SELECT * FROM clcot_tmp WHERE cliente='$codigoo' and usu='$usu' and rut='' and email='$email'");    
                            if($row=mysql_fetch_array($pa)){
                                
                                mysql_query("UPDATE clcot_tmp SET fecha='$fecha' WHERE cliente='$codigoo' and usu='$usu' and email='$email'");
                            }else{
                                mysql_query("INSERT INTO clcot_tmp (cliente, fecha, usu, email) VALUES ('$codigoo','$fecha','$usu','$email')");   
                            }
                        }else{
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                     <table class="table">
                        <?php 
                                $neto=0;$item=0;
                                $pa=mysql_query("SELECT * FROM clcot_tmp, clientes WHERE clcot_tmp.usu='$usu' and clcot_tmp.cliente=clientes.id");                
                                while($row=mysql_fetch_array($pa)){
                                    ############# FECHA ######################
                                    if($row['fecha']==NULL){
                            ...
                            ?>
                            <!--<tr>
                                <td colspan="5"><div align="center"><strong><?php echo $row['nombre']; ?></strong></div></td>                                           
                              </tr>-->
                            <tr class="well-dos">
                            ...
                            <a href="#" role="button" class="btn btn-default" data-toggle="modal">
                                       <strong><?php echo $row['nombre']; ?>
                                </a>
                            </td>                              
                             <td>
                                <a href="#dir<?php echo $row['id']; ?>" role="button" class="btn btn-default" data-toggle="modal">
                                        <strong><?php echo $dir; ?></strong>
                                </a>
                             </td>                      
                                <td>                                
                                        <a href="#fecha<?php echo $row['id']; ?>" role="button" class="btn btn-success" data-toggle="modal" title="Cambiar Fecha">
                                            <strong><?php echo fecha($fecha); ?></strong>
                                        </a>                                 
                                </td>
                                <td>
                                        <a href="#status<?php echo $row['id']; ?>" role="button" class="btn btn-danger" data-toggle="modal" title="Cambiar Fecha">
                                            <strong><?php echo $statusx; ?> </strong>
                                        </a>  
                                    <!-- <?php echo $status; ?>-->
                                </td>                                                                                               
                                <td>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <br>
                                             ...
                                             <!--<div class="input-group">
                                                ...
                                                <input type="number" class="form-control input-lg" name="valor_recibido" required min="0" step="any" min="<?php echo $subtotal; ?>"  autocomplete="off" required><br>                                         
