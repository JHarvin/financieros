<?php 
    ...
    if(!empty($_GET['del'])){
        $id=$_GET['del'];
        mysql_query("DELETE FROM tipos WHERE id='$id'");
        header('index.php');
    }
?>
<!DOCTYPE html>
			 ...
			 <div class="row">
                    <div class="col-md-12">                        
                          <div class="panel-body" align="center">                                                                                 
                            <button type="button" class="btn btn-success btn-circle" data-toggle="modal" data-target="#myModal" title="Agregar Tipo"><i class="fa fa-plus fa-2x"></i>
                            </button>                                                                            
                  </div>
                    </div>
                </div> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h3 align="center" class="modal-title" id="myModalLabel">Nuevo Tipo de Vehiculo</h3>
                                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <?php 
                                    if(!empty($_POST['nombre'])){                                               
                                        ...
                                        if(empty($_POST['id'])){
                                            $oCategoria=new Proceso_Tipos('',$nombre,$estado);
                                            $oCategoria->crear();
                                            echo mensajes('Tipo "'.$nombre.'" Creada con Exito','verde');
                                        }else{
                                            $id=limpiar($_POST['id']);
                                            $oCategoria=new Proceso_Tipos($id,$nombre,$estado);
                                            $oCategoria->actualizar();
                                            echo mensajes('Tipo "'.$nombre.'" Actualizada con Exito','verde');
                                        }
                                    }
                                ?>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php                                             
                                            $pame=mysql_query("SELECT * FROM tipos ORDER BY nombre");                                                        
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h3 align="center" class="modal-title" id="myModalLabel">Editar Tipo de Vehiculo</h3>
                                                            </div>
                                                            <div class="panel-body">
                                                            <div class="row">                                       
                                                                <div class="col-md-6">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="row" align="center">                                       
                                                                ...
                                                                <div class="alert alert-danger">
                                                                    ...
                                                                    una vez Eliminada el Tipo <strong>[ <?php echo $row['nombre']; ?> ]</strong> no podra ser Recuperada.</h4>
                                                                </div>                                                                                                                                                                                                                                                                                                                                                                                                                              
                                                            </div> 
                                                            </div> 
                                                            <div class="modal-footer">
