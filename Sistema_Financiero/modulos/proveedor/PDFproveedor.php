...
<table class="table table-hover" width="100%" border="0">	 
      <tr class="well">
		<td colspan="6"><strong><center>LISTADO DE PROVEEDOR</center></strong></td>
		</tr>		
</table>
...
<table width="100%" border="0">		
    ...
    <table class="table table-hover" width="100%" border="0">
      <tr class="well">
		...
		$num=0;
        $can=mysql_query("SELECT * FROM proveedor WHERE estado='s' ORDER BY id");	
      ...
      <tr>        
        ...
        <td bgcolor="'.$color.'">'.$dato['nit'].'</td>
        <td bgcolor="'.$color.'">'.$dato['contacto'].'</td>         
      </tr>';
         }
	$codigoHTML.='
	</table>
